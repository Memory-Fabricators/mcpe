...
public:
  static void addRecipes(Recipes *r) {
    ...
    for (int i = 0; i < 16; i++) {
      if (i == DyePowderItem::BLACK || i == DyePowderItem::BROWN ||
          i == DyePowderItem::SILVER || i == DyePowderItem::GRAY ||
    ...
    // some dye recipes
    r->addShapelessRecipe(
        ItemInstance(Item::dye_powder, 2, DyePowderItem::YELLOW),
        definition(0, Tile::flower));
    // r->addShapelessRecipe(ItemInstance(Item::dye_powder, 2,
    // DyePowderItem::RED), definition(Tile*)Tile::rose));
    r->addShapelessRecipe(
        ItemInstance(Item::dye_powder, 3, DyePowderItem::WHITE),
    ...
    //         DyePowderItem::BLACK), 0, ItemInstance(Item::dye_powder, 1,
    //         DyePowderItem::WHITE)));
    //     r->addShapelessRecipe(ItemInstance(Item::dye_powder, 2,
    //     DyePowderItem::SILVER), //
    //         definition(0, ItemInstance(Item::dye_powder, 1,
    //         DyePowderItem::GRAY), 0, ItemInstance(Item::dye_powder, 1,
    //         DyePowderItem::WHITE)));
    //     r->addShapelessRecipe(ItemInstance(Item::dye_powder, 3,
    //     DyePowderItem::SILVER), //
    //         definition(0, ItemInstance(Item::dye_powder, 1,
    //         DyePowderItem::BLACK), 0, ItemInstance(Item::dye_powder, 1,
    //         DyePowderItem::WHITE), 0, ItemInstance(Item::dye_powder, 1,
    //         DyePowderItem::WHITE)));
    //        r->addShapelessRecipe(ItemInstance(Item::dye_powder, 2,
    //        DyePowderItem::BROWN), //
    //                definition(0, ItemInstance(Item::dye_powder, 1,
    //                DyePowderItem::BLACK), 0, ItemInstance(Item::dye_powder,
    //                1, DyePowderItem::ORANGE)));
    //        r->addShapelessRecipe(ItemInstance(Item::dye_powder, 3,
    //        DyePowderItem::BROWN), //
    //                definition(0, ItemInstance(Item::dye_powder, 1,
    //                DyePowderItem::BLACK), 0, ItemInstance(Item::dye_powder,
    //                1, DyePowderItem::RED), 0, ItemInstance(Item::dye_powder,
    //                1, DyePowderItem::YELLOW)));
    r->addShapelessRecipe(
    ...
    //     definition(0, ItemInstance(Item::dye_powder, 1,
    //     DyePowderItem::PURPLE), 0, ItemInstance(Item::dye_powder, 1,
    //     DyePowderItem::PINK)));
    // r->addShapelessRecipe(ItemInstance(Item::dye_powder, 3,
    // DyePowderItem::MAGENTA), //
    //     definition(0, ItemInstance(Item::dye_powder, 1, DyePowderItem::BLUE),
    //     0, ItemInstance(Item::dye_powder, 1, DyePowderItem::RED), 0,
    //     ItemInstance(Item::dye_powder, 1, DyePowderItem::PINK)));
    r->addShapelessRecipe(
