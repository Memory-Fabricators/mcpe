...
Monster::Monster(Level *level)
    : super(level), attackDamage(2), targetId(0), lastHurtByMobId(0) {
...
bool Monster::canSpawn() { return isDarkEnoughToSpawn() && super::canSpawn(); }
...
int Monster::getCreatureBaseType() const { return MobTypes::BaseEnemy; }
...
void Monster::setTarget(Mob *mob) { targetId = mob ? mob->entityId : 0; }
...
int Monster::getAttackDamage(Entity *target) { return attackDamage; }

int Monster::getAttackTime() { return 20; }
