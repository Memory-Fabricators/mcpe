...
Spider::Spider(Level *level) : super(level), fireCheckTick(0) {
...
void Spider::aiStep() { super::aiStep(); }
...
int Spider::getEntityTypeId() const { return MobTypes::Spider; }
...
const char *Spider::getAmbientSound() { return "mob.spider"; }

std::string Spider::getHurtSound() { return "mob.spider"; }

std::string Spider::getDeathSound() { return "mob.spiderdeath"; }
