...
PigZombie::PigZombie(Level *level)
    : super(level), angerTime(0), playAngrySoundIn(0), weapon(Item::sword_gold),
...
std::string PigZombie::getTexture() { return "mob/pigzombie.png"; }
...
const char *PigZombie::getAmbientSound() { return "mob.zombiepig.zpig"; }

std::string PigZombie::getHurtSound() { return "mob.zombiepig.zpighurt"; }

std::string PigZombie::getDeathSound() { return "mob.zombiepig.zpigdeath"; }
...
bool PigZombie::interact(Player *player) { return false; }

int PigZombie::getDeathLoot() { return 0; }

ItemInstance *PigZombie::getCarriedItem() { return &weapon; }

int PigZombie::getEntityTypeId() const { return MobTypes::PigZombie; }

int PigZombie::getAttackTime() { return 40; }
