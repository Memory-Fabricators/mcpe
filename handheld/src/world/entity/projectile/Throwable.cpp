...
Throwable::Throwable(Level *level) : super(level) {
  _init();
  setSize(0.25f, 0.25f);
}

Throwable::Throwable(Level *level, Mob *mob) : super(level) {
  _init();
  setSize(0.25f, 0.25f);
...
Throwable::Throwable(Level *level, float x, float y, float z) : super(level) {
  _init();
  setSize(0.25f, 0.25f);
...
int Throwable::getAuxData() { return ownerId; }
