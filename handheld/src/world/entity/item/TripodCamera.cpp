...
bool TripodCamera::isPickable() { return !removed; }

bool TripodCamera::interactPreventDefault() { return true; }
...
float TripodCamera::getShadowHeightOffs() { return 0; }

bool TripodCamera::isPushable() { return false; }
