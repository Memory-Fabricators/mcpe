...
Cow::Cow(Level *level) : super(level) {
...
int Cow::getEntityTypeId() const { return MobTypes::Cow; }
...
bool Cow::interact(Player *player) {
  ...
  //     player->inventory.setItem(player->inventory.selected, /*new*/
  //     ItemInstance(Item::milk)); return true;
  // }
  return super::interact(player);
}

const char *Cow::getAmbientSound() { return "mob.cow"; }

std::string Cow::getHurtSound() { return "mob.cowhurt"; }

std::string Cow::getDeathSound() { return "mob.cowhurt"; }
...
Animal *Cow::getBreedOffspring(Animal *target) { return new Cow(level); }
