...
int Pig::getEntityTypeId() const { return MobTypes::Pig; }

bool Pig::interact(Player *player) { return false; }
...
const char *Pig::getAmbientSound() { return "mob.pig"; }

std::string Pig::getHurtSound() { return "mob.pig"; }

std::string Pig::getDeathSound() { return "mob.pigdeath"; }
...
Animal *Pig::getBreedOffspring(Animal *target) { return new Pig(level); }
