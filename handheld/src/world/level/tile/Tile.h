...
public:
  ...
  public:
    ...
    const std::string &getStepSound() const { return stepSound; }
  };
  ...
  // invisible bedrock is used to block off empty chunks (i.e. prevent player
  // movement)
...
protected:
  ...
  /*** Returns the item instance's auxValue when a TileItem is spawned from this
   * Tile. */
