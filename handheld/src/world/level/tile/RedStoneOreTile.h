...
public:
  RedStoneOreTile(int id, int tex, bool lit) : Tile(id, tex, Material::stone) {
    if (lit) {
  ...
  int getResourceCount(Random *random) { return 4 + random->nextInt(2); }
