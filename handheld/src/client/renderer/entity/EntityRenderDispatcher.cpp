...
/*static*/
float EntityRenderDispatcher::xOff = 0, EntityRenderDispatcher::yOff = 0,
      EntityRenderDispatcher::zOff = 0;

EntityRenderDispatcher::EntityRenderDispatcher() : itemInHandRenderer(NULL) {
...
void EntityRenderDispatcher::setLevel(Level *level) { this->level = level; }
...
Font *EntityRenderDispatcher::getFont() { return _font; }
