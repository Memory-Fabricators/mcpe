...
Screen *ScreenChooser::createScreen(ScreenId id) {
  ...
  if (_mc->useTouchscreen()) {
    ...
    case SCREEN_STARTMENU:
      screen = new Touch::StartMenuScreen();
      break;
    case SCREEN_SELECTWORLD:
      screen = new Touch::SelectWorldScreen();
      break;
    case SCREEN_JOINGAME:
      screen = new Touch::JoinGameScreen();
      break;
    case SCREEN_PAUSE:
      screen = new PauseScreen(false);
      break;
    case SCREEN_PAUSEPREV:
    ...
    case SCREEN_PAUSEPREV:
      ...
      break;
    case SCREEN_BLOCKSELECTION:
      screen = new IngameBlockSelectionScreen();
      break;
