...
public:
  ...
  void blit(float x, float y, int sx, int sy, float w, float h, int sw = 0,
            int sh = 0);
...
protected:
  ...
  void fillHorizontalGradient(int x0, int y0, int x1, int y1, int col1,
                              int col2);
  void fillHorizontalGradient(float x0, float y0, float x1, float y1, int col1,
                              int col2);
