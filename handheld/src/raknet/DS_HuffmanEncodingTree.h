...
/// \brief \b [Internal] Generates a huffman encoding tree, used for string and
/// global compression.
///
...
/// with the additional condition that unused combinations of 8 bits are treated
/// as a frequency of 1
...
public:
  ...
  /// \brief Pass an array of bytes to array and a preallocated BitStream to
  /// receive the output.
