...
public:
  ...
  bool OnCommand(const char *command, unsigned numParameters,
  ...
  void SendHelp(TransportInterface *transport,
                const SystemAddress &systemAddress);
  ...
  void OnNewIncomingConnection(const SystemAddress &systemAddress,
  ...
  /// \param[in] transport The transport interface that sent us this
  /// information.
  void OnConnectionLost(const SystemAddress &systemAddress,
                        TransportInterface *transport);
...
protected:
  ...
  void PrintChannels(const SystemAddress &systemAddress,
  ...
  unsigned Unsubscribe(const SystemAddress &systemAddress,
  ...
  unsigned Subscribe(const SystemAddress &systemAddress,
                     const char *channelName);
