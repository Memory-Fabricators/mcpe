...
template <class range_type> RangeList<range_type>::RangeList() {
...
template <class range_type> void RangeList<range_type>::Clear(void) {
  ranges.Clear(true, _FILE_AND_LINE_);
}

template <class range_type> unsigned RangeList<range_type>::Size(void) const {
  return ranges.Size();
}
