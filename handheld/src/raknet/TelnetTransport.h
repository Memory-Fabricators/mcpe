/// \file
/// \brief Contains TelnetTransport , used to supports the telnet transport
/// protocol.  Insecure
///
...
/// \brief Use TelnetTransport to easily allow windows telnet to connect to your
/// ConsoleServer
/// \details To run Windows telnet, go to your start menu, click run, and in the
/// edit box type "telnet <IP>" where <IP> is the ip address.<BR> of your
/// ConsoleServer (most likely the same IP as your game).<BR> This
/// implementation always echos commands.
