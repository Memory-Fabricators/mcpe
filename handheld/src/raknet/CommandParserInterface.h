...
public:
  ...
  virtual void SendHelp(TransportInterface *transport,
  ...
  virtual bool OnCommand(const char *command, unsigned numParameters,
  ...
  static void ParseConsoleString(char *str, const char delineator,
  ...
  virtual void SendCommandList(TransportInterface *transport,
                               const SystemAddress &systemAddress);
  ...
  virtual void RegisterCommand(unsigned char parameterCount,
  ...
  virtual void ReturnResult(bool res, const char *command,
                            TransportInterface *transport,
                            const SystemAddress &systemAddress);
  virtual void ReturnResult(char *res, const char *command,
                            TransportInterface *transport,
                            const SystemAddress &systemAddress);
  virtual void ReturnResult(SystemAddress res, const char *command,
                            TransportInterface *transport,
                            const SystemAddress &systemAddress);
  virtual void ReturnResult(int res, const char *command,
                            TransportInterface *transport,
                            const SystemAddress &systemAddress);
...
protected:
  DataStructures::OrderedList<const char *, RegisteredCommand,
