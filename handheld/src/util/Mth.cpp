...
float random() { return _rand.nextFloat(); }
int random(int n) { return _rand.nextInt(n); }
...
float absMaxSigned(float a, float b) { return abs(a) > abs(b) ? a : b; }
}; // namespace Mth
