...
public:
  ServerSideNetworkHandler(Minecraft *minecraft,
  ...
  // virtual void handle(const RakNet::RakNetGUID& source, PlaceBlockPacket*
  // packet);
  virtual void handle(const RakNet::RakNetGUID &source,
                      RemoveBlockPacket *packet);
  // virtual void handle(const RakNet::RakNetGUID& source, ExplodePacket*
  // packet);
  virtual void handle(const RakNet::RakNetGUID &source,
