...
//  All rights reserved.
//
//  It is appreciated but not required that you give credit to Luc Vandal and
//  Ortwin Gentz, as the original authors of this code. You can give credit in a
//  blog post, a tweet or on a info page of your app. Also, the original authors
//  appreciate letting them know if you use this code.
//
...
#define kIASKgrayBlueColor                                                     \
  [UIColor colorWithRed:0.318 green:0.4 blue:0.569 alpha:1.0]
