...
/// UDPProxyServer. It allows UDPProxyServer to control our instance of
/// UDPForwarder.
///
...
struct UDPProxyServerResultHandler {
  ...
  /// \param[out] usedPassword The password we passed to
...
/// via the UDPProxyServer plugin.<BR> The UDPProxyServer connects to
/// UDPProxyServer to get a list of servers running UDPProxyServer, and the
...
public:
  ...
  /// to change away from the default UDPForwarder::Startup(),
  /// UDPForwarder::Shutdown(), and UDPForwarder::Update() are called
