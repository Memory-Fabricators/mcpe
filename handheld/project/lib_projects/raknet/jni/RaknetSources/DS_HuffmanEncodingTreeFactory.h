...
/// \brief Creates instances of the class HuffmanEncodingTree
/// \details This class takes a frequency table and given that frequence table,
/// will generate an instance of HuffmanEncodingTree
...
public:
  ...
  /// \details You don't need to call this unless you want to reuse the class
  /// for a new tree
  void Reset(void);

  /// \brief Pass an array of bytes to this to add those elements to the
  /// frequency table.
  ...
  /// \brief Copies the frequency table to the array passed. Retrieve the
  /// frequency table.
  ...
  /// \details You can also use GetFrequencyTable and GenerateFromFrequencyTable
  /// in the tree itself
