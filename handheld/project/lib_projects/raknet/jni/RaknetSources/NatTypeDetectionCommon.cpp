...
bool RakNet::CanConnect(NATTypeDetectionResult type1,
  ...
  bool connectionGraph[NAT_TYPE_COUNT][NAT_TYPE_COUNT] = {
      // None,	Full Cone,	Address Restricted,		Port Restricted,
      // Symmetric,	Unknown,	InProgress,	Supports_UPNP
...
SOCKET RakNet::CreateNonblockingBoundSocket(const char *bindAddr) {
  SOCKET s =
      SocketLayer::CreateBoundSocket(0, false, bindAddr, true, 0, AF_INET);
#ifdef _WIN32
