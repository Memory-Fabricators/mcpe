...
EntityRenderer::EntityRenderer() : shadowRadius(0), shadowStrength(1.0f) {}
...
//         float dist = entityRenderDispatcher.distanceToSqr(entity.x, entity.y,
//         entity.z); float pow = (float) ((1 - dist / (16.0f * 16.0f)) *
//         shadowStrength); if (pow > 0) {
