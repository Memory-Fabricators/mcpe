...
// DynamicTexture
//
DynamicTexture::DynamicTexture(int tex_) : tex(tex_), replicate(1) {
...
WaterTexture::WaterTexture() : super(Tile::water->tex), _tick(0), _frame(0) {
...
WaterSideTexture::WaterSideTexture()
    : super(Tile::water->tex + 1), _tick(0), _frame(0), _tickCount(0) {
  replicate = 2;
