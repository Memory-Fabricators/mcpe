...
public:
  ...
  // float z1) {
  //     return frustum.cubeFullyInFrustum(x0 - xOff, y0 - yOff, z0 - zOff, x1 -
  //     xOff, y1 - yOff, z1 - zOff);
  // }
  ...
  bool cubeFullyInFrustum(float x0, float y0, float z0, float x1, float y1,
    ...
    for (int p = 0; p < 6; p++) {
      int c = 0;
      if (frustum[p][0] * (x0) + frustum[p][1] * (y0) + frustum[p][2] * (z0) +
              frustum[p][3] >
          0)
        c++;
      if (frustum[p][0] * (x1) + frustum[p][1] * (y0) + frustum[p][2] * (z0) +
              frustum[p][3] >
          0)
        c++;
      if (frustum[p][0] * (x0) + frustum[p][1] * (y1) + frustum[p][2] * (z0) +
              frustum[p][3] >
          0)
        c++;
      if (frustum[p][0] * (x1) + frustum[p][1] * (y1) + frustum[p][2] * (z0) +
              frustum[p][3] >
          0)
        c++;
      if (frustum[p][0] * (x0) + frustum[p][1] * (y0) + frustum[p][2] * (z1) +
              frustum[p][3] >
          0)
        c++;
      if (frustum[p][0] * (x1) + frustum[p][1] * (y0) + frustum[p][2] * (z1) +
              frustum[p][3] >
          0)
        c++;
      if (frustum[p][0] * (x0) + frustum[p][1] * (y1) + frustum[p][2] * (z1) +
              frustum[p][3] >
          0)
        c++;
      if (frustum[p][0] * (x1) + frustum[p][1] * (y1) + frustum[p][2] * (z1) +
              frustum[p][3] >
          0)
        c++;
      if (c == 0)
