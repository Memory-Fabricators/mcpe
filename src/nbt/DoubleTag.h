...
public:
  ...
  DoubleTag(const std::string &name) : super(name) {}

  DoubleTag(const std::string &name, double data) : super(name), data(data) {}
  ...
  //@Override
  Tag *copy() const { return new DoubleTag(getName(), data); }
