...
bool HoeItem::useOn(ItemInstance *itemInstance, Player *player, Level *level,
  ...
  if (face != 0 && above == 0 && targetType == Tile::grass->id ||
      targetType == Tile::dirt->id) {
...
bool HoeItem::isHandEquipped() const { return true; }
