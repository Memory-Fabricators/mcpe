...
void ToolRecipes::addRecipes(Recipes *r) {
  int materialIds[] = {Tile::wood->id, Tile::stoneBrick->id,
                       Item::ironIngot->id, Item::emerald->id,
                       Item::goldIngot->id};
  ...
  Item *map[NumRecipes][NumMaterials] = {
      {Item::pickAxe_wood, Item::pickAxe_stone, Item::pickAxe_iron,
       Item::pickAxe_emerald, Item::pickAxe_gold},
      {Item::shovel_wood, Item::shovel_stone, Item::shovel_iron,
       Item::shovel_emerald, Item::shovel_gold},
      {Item::hatchet_wood, Item::hatchet_stone, Item::hatchet_iron,
       Item::hatchet_emerald, Item::hatchet_gold},
      {Item::hoe_wood, Item::hoe_stone, Item::hoe_iron, Item::hoe_emerald,
       Item::hoe_gold},
  };
