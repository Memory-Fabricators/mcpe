...
public:
  ...
  std::string getName() { return "Memory Storage"; }
  ...
  LevelData *getDataTagFor(const std::string &levelId) { return NULL; }

  bool isNewLevelIdAcceptable(const std::string &levelId) { return true; }
