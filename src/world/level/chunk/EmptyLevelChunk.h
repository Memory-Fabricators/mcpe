...
public:
  EmptyLevelChunk(Level *level, int x, int z) : LevelChunk(level, x, z) {
    dontSave = true;
  }
  ...
  bool isAt(int x, int z) { return x == this->x && z == this->z; }

  int getHeightmap(int x, int z) { return 0; }

  void recalcBlockLights() {}

  void recalcHeightmapOnly() { return; }

  void recalcHeightmap() { return; }

  void lightLava() { return; }
  ...
  bool setTile(int x, int y, int z, int _tile) { return true; }

  int getData(int x, int y, int z) { return 0; }

  void setData(int x, int y, int z, int val) { return; }
  ...
  int getRawBrightness(int x, int y, int z, int skyDampen) { return 7; }

  void addEntity(Entity *e) { return; }

  void removeEntity(Entity *e) { return; }

  void removeEntity(Entity *e, int yc) { return; }

  bool isSkyLit(int x, int y, int z) { return false; }

  void skyBrightnessChanged() { return; }
  /*
  ...
  void markUnsaved() { return; }

  void getEntities(Entity *except, const AABB &bb, std::vector<Entity *> &es) {
    return;
  }
  /*
void getEntitiesOfClass(Class<? extends Entity> baseClass, AABB bb, List<Entity>
es) { return;
}
