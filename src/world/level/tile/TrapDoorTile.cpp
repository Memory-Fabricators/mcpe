...
TrapDoorTile::TrapDoorTile(int id, const Material *material)
    : super(id, material) {
  tex = 4 + 5 * 16;
...
bool TrapDoorTile::isSolidRender() { return false; }

bool TrapDoorTile::isCubeShaped() { return false; }

int TrapDoorTile::getRenderShape() { return Tile::SHAPE_BLOCK; }

int TrapDoorTile::getRenderLayer() { return Tile::RENDERLAYER_ALPHATEST; }
