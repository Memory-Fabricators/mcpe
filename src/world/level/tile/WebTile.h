...
public:
  WebTile(int id, int tex) : super(id, tex, Material::web) {}

  int getRenderLayer() { return RENDERLAYER_ALPHATEST; }
  ...
  /*@Override*/
  int getResource(int data, Random *random) { return Item::string->id; }
};
