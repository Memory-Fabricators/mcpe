...
public:
  ClothTile(int id) : super(id, 4 * 16, Material::cloth) {}
  ClothTile(int id, int data) : super(id, 4 * 16, Material::cloth) {}
...
protected:
  int getSpawnResourcesAuxValue(int data) { return data; }
  static int getItemAuxValueForTileData(int data) { return (~data & 0xf); }
};
