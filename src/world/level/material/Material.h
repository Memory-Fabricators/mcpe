...
public:
  ...
  virtual bool letsWaterThrough() const { return (!isLiquid() && !isSolid()); }
  ...
  virtual bool blocksMotion() const { return true; }

  virtual bool isFlammable() const { return _flammable; }

  virtual bool isReplaceable() const { return _replaceable; }

  virtual ~Material() {}

protected:
  Material()
      : _flammable(false), _neverBuildable(false), _isAlwaysDestroyable(true),
        _replaceable(false) {}
