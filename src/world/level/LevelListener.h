...
public:
  ...
  virtual void tileBrightnessChanged(int x, int y, int z) {
    tileChanged(x, y, z);
  }
  ...
  virtual void addParticle(const std::string &name, float x, float y, float z,
                           float xa, float ya, float za, int data) {}
  virtual void addParticle(ParticleType::Id name, float x, float y, float z,
                           float xa, float ya, float za, int data) {}

  virtual void playSound(const std::string &name, float x, float y, float z,
                         float volume, float pitch) {}
  virtual void playMusic(const std::string &name, float x, float y, float z,
                         float songOffset) {}
  ...
  virtual void levelEvent(Player *source, int type, int x, int y, int z,
                          int data) {}
