...
Chicken::Chicken(Level *level)
    : super(level), sheared(false), flap(0), oFlap(0), flapSpeed(0),
      oFlapSpeed(0), flapping(1), eggTime(0) {
...
void Chicken::aiStep() {
  ...
  //		level->playSound(this, "mob.chickenplop", 1.0f,
...
const char *Chicken::getAmbientSound() { return "mob.chicken"; }

std::string Chicken::getHurtSound() { return "mob.chickenhurt"; }

std::string Chicken::getDeathSound() { return "mob.chickenhurt"; }
