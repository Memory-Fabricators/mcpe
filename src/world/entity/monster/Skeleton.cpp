...
Skeleton::Skeleton(Level *level)
    : super(level), bow(Item::bow, 1), fireCheckTick(0) {
...
ItemInstance *Skeleton::getCarriedItem() { return &bow; }

int Skeleton::getEntityTypeId() const { return MobTypes::Skeleton; }

const char *Skeleton::getAmbientSound() { return "mob.skeleton"; }

std::string Skeleton::getHurtSound() { return "mob.skeletonhurt"; }

std::string Skeleton::getDeathSound() { return "mob.skeletonhurt"; }
...
int Skeleton::getUseDuration() { return attackTime; }
