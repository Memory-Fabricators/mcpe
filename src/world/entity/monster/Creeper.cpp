...
Creeper::Creeper(Level *level)
    : super(level), swell(0), oldSwell(0), swellDir(-1) {
...
int Creeper::getMaxHealth() { return 16; }
...
int Creeper::getEntityTypeId() const { return MobTypes::Creeper; }
...
std::string Creeper::getHurtSound() { return "mob.creeper"; }

std::string Creeper::getDeathSound() { return "mob.creeperdeath"; }
...
int Creeper::getSwellDir() { return (int)entityData.getByte(DATA_SWELL_DIR); }
