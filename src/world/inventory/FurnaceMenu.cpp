...
FurnaceMenu::FurnaceMenu(FurnaceTileEntity *furnace)
    : super(ContainerType::FURNACE), furnace(furnace), lastTickCount(0),
      lastLitTime(0), lastLitDuration(0) {
...
void FurnaceMenu::broadcastChanges() {
  ...
  // lastTickCount, furnace->litTime, lastLitTime);
