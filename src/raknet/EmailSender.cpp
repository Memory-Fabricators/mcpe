...
#pragma warning(disable : 4127) // conditional expression is constant
  ...
  // Write the body of the email, doing some lame shitty shit where I have to
  // make periods at the start of a newline have a second period.
  char *newBody;
  int bodyLength;
  ...
  for (i = 1, j = 1; i < bodyLength; i++) {
    ...
    // Transform \n . . \n into \n . . . \r \n (this is a bug in the mail server
    // - the spec says do not count \n alone but it does) In fact having to
  ...
  // What a pain in the rear.  I have to map the binary to printable characters
...
// 			if (strstr((const char*)packet->data, "250-AUTH LOGIN
// PLAIN"))
// 			{
// 				tcpInterface->StartSSLClient(packet->systemAddress);
// 				return "AUTHENTICATE"; // OK
