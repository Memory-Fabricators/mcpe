/// \file
/// \brief If _USE_RAK_MEMORY_OVERRIDE is defined, memory allocations go through
/// rakMalloc, rakRealloc, and rakFree
///
...
extern RAK_DLL_EXPORT void *(*rakMalloc_Ex)(size_t size, const char *file,
                                            unsigned int line);
extern RAK_DLL_EXPORT void *(*rakRealloc_Ex)(void *p, size_t size,
                                             const char *file,
                                             unsigned int line);
extern RAK_DLL_EXPORT void (*rakFree_Ex)(void *p, const char *file,
                                         unsigned int line);
extern RAK_DLL_EXPORT void (*notifyOutOfMemory)(const char *file,
                                                const long line);
...
void RAK_DLL_EXPORT SetMalloc_Ex(void *(*userFunction)(size_t size,
                                                       const char *file,
                                                       unsigned int line));
void RAK_DLL_EXPORT SetRealloc_Ex(void *(*userFunction)(void *p, size_t size,
                                                        const char *file,
                                                        unsigned int line));
void RAK_DLL_EXPORT SetFree_Ex(void (*userFunction)(void *p, const char *file,
                                                    unsigned int line));
// Change to a user defined out of memory function
void RAK_DLL_EXPORT SetNotifyOutOfMemory(void (*userFunction)(const char *file,
                                                              const long line));
...
void RAK_DLL_EXPORT SetDLMallocMUnmap(int (*userFunction)(void *ptr,
                                                          size_t size));
...
extern RAK_DLL_EXPORT void *(*GetMalloc_Ex())(size_t size, const char *file,
                                              unsigned int line);
extern RAK_DLL_EXPORT void *(*GetRealloc_Ex())(void *p, size_t size,
                                               const char *file,
                                               unsigned int line);
extern RAK_DLL_EXPORT void (*GetFree_Ex())(void *p, const char *file,
                                           unsigned int line);
...
RAK_DLL_EXPORT Type *OP_NEW_1(const char *file, unsigned int line,
                              const P1 &p1) {
#if _USE_RAK_MEMORY_OVERRIDE == 1
  char *buffer = (char *)(GetMalloc_Ex())(sizeof(Type), file, line);
...
RAK_DLL_EXPORT Type *OP_NEW_2(const char *file, unsigned int line, const P1 &p1,
                              const P2 &p2) {
#if _USE_RAK_MEMORY_OVERRIDE == 1
  char *buffer = (char *)(GetMalloc_Ex())(sizeof(Type), file, line);
...
RAK_DLL_EXPORT Type *OP_NEW_3(const char *file, unsigned int line, const P1 &p1,
...
RAK_DLL_EXPORT Type *OP_NEW_4(const char *file, unsigned int line, const P1 &p1,
...
template <class Type>
RAK_DLL_EXPORT Type *OP_NEW_ARRAY(const int count, const char *file,
                                  unsigned int line) {
  if (count == 0)
    return 0;
...
template <class Type>
RAK_DLL_EXPORT void OP_DELETE_ARRAY(Type *buff, const char *file,
                                    unsigned int line) {
#if _USE_RAK_MEMORY_OVERRIDE == 1
  if (buff == 0)
    return;
...
void RAK_DLL_EXPORT *_RakMalloc_Ex(size_t size, const char *file,
                                   unsigned int line);
void RAK_DLL_EXPORT *_RakRealloc_Ex(void *p, size_t size, const char *file,
                                    unsigned int line);
...
// Call to make RakNet allocate a large block of memory, and do all subsequent
// allocations in that memory block Initial and reallocations will be done
// through whatever function is pointed to by yourMMapFunction, and
// yourDirectMMapFunction (default is malloc) Allocations will be freed through
// whatever function is pointed to by yourMUnmapFunction (default free)
