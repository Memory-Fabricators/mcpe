...
public:
  ...
  static void feedText(char character) { _inputText.push_back(character); }
  ...
  static int getEventKey() { return _inputs[_index].key; }

  static int getEventKeyState() { return _inputs[_index].state; }
  static char getChar() { return _inputText[_textIndex]; }
