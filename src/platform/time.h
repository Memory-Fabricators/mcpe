...
public:
  SwStartStopper(Stopwatch &stopwatch) : _stopwatch(stopwatch) {
    _stopwatch.start();
  }

  ~SwStartStopper() { _stopwatch.stop(); }
...
class SwStopper {
public:
  SwStopper(Stopwatch &stopwatch) : _stopwatch(stopwatch) {}

  ~SwStopper() { _stopwatch.stop(); }
...
public:
  StopwatchHandler() : _printcounter(0) {}
