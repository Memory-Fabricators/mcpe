...
#define LOGV(...)                                                              \
  ((void)__android_log_print(ANDROID_LOG_VERBOSE, "MinecraftPE", __VA_ARGS__))
#define LOGI(...)                                                              \
  ((void)__android_log_print(ANDROID_LOG_INFO, "MinecraftPE", __VA_ARGS__))
#define LOGW(...)                                                              \
  ((void)__android_log_print(ANDROID_LOG_WARN, "MinecraftPE", __VA_ARGS__))
#define LOGE(...)                                                              \
  ((void)__android_log_print(ANDROID_LOG_ERROR, "MinecraftPE", __VA_ARGS__))
#define printf LOGI
#endif
#else
#ifdef PUBLISH
